        ...
        <div class="media text-muted pt-3">
            ...
            <div class="mt-3 px-4"><span class="text-uppercase name">Profile Picture</span>
                <div class="d-flex flex-row align-items-center mt-2">
                    <img src="<c:url value = "${user.avatar}"/>" width="60" class="rounded">
                    <div class="ml-3">
                            <a href="profileEdit?editField=avatar&type=file" class="btn btn-outline-primary"> Upload new picture</a>
                    </div>
                </div>
            </div>
